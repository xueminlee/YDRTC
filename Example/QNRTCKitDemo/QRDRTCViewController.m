...
- (void)requestToken {
    ...
    [QRDNetworkUtil requestTokenWithRoomName:self.roomName appId:self.appId userId:self.userId completionHandler:^(NSError *error, NSString *token) {
        ...
        if (error) {
            ...
            wself.token = token; //@"29Uw4roPWvX-7RNJOn0Ll1pB1IfPLdKuLyVDv6WE:3pABGOoNbKzX6-Y6_y8I9YuMaYI=:eyJhcHBJZCI6ImZnbmFmZzJhbCIsInJvb21OYW1lIjoieWlkaWFuLWxpZmUtMSIsInVzZXJJZCI6ImFiYy0wMDQiLCJleHBpcmVBdCI6MTYxMzIwNTc0MjIyMSwicGVybWlzc2lvbiI6InVzZXIifQ=="; //@"29Uw4roPWvX-7RNJOn0Ll1pB1IfPLdKuLyVDv6WE:yuvOX12cee2DrQu8HOYQ0p50X_k=:eyJhcHBJZCI6ImZnbmFmZzJhbCIsInJvb21OYW1lIjoieWlkaWFuLWxpZmUtMSIsInVzZXJJZCI6ImFiYy0wMDEiLCJleHBpcmVBdCI6MTYxMjM0ODc0MywicGVybWlzc2lvbiI6ImFkbWluIn0=";
            // 加入房间
            [wself joinRTCRoom];
        }
    }];
