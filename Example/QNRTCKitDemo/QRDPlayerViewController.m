...
- (void)viewDidLoad {
    ...
    if ([self.appId isEqualToString:QN_RTC_DEMO_APPID]) {
        _url = [NSString stringWithFormat:@"rtmp://pili-live-rtmp.v.fafengtuqiang.cn/onlinelive/%@",self.roomName]; // @"rtmp://pili-rtmp.qnsdk.com/sdk-live/%@"
    } else {
        _url = [NSString stringWithFormat:@"rtmp://pili-live-rtmp.v.fafengtuqiang.cn/onlinelive/%@_%@",self.appId, self.roomName]; // @"rtmp://pili-rtmp.qnsdk.com/sdk-live/%@_%@"
    }
